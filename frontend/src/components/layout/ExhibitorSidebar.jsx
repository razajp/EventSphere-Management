...
const links = [
  { path: "/exhibitor", label: "Dashboard", icon: LayoutDashboard },
  { path: "/exhibitor/expos", label: "Expos", icon: Building2 },
  { path: "/exhibitor/exhibitors", label: "Exhibitors", icon: Users2 },
  { path: "/exhibitor/attendees", label: "Attendees", icon: Users2 },
  { path: "/exhibitor/analytics", label: "Analytics", icon: BarChart3 },
  { path: "/exhibitor/settings", label: "Settings", icon: Settings },
];
